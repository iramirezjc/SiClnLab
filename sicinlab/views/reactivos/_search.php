...
/** @var app\models\searchs\BuscaReactivo $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="reactivos-search">
    ...
    <div class="d-flex justify-content-center align-items-center">
        <?= 
            $form->field($model, 'Nombre')-> textInput([
                'placeholder' => 'Buscar por nombre del reactivo...', 'class' => 'form-control',
                'style' => 'width: 600px;'
            ])
            -> label(false)
        ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn-limpiar').on('click', function() {
            ...
            $('input[name="BuscaReactivo[Nombre]"]').val('');
